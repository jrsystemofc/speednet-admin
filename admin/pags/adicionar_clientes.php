	            ...
	            <ul class="list-unstyled components">
	                ...
	                <li class="active">
	                    ...
	                    <ul class="collapse list-unstyled" id="homeSubmenu">
	                        <li>
	                            <a href="adicionar_clientes.php"><i class="fas fa-circle"></i> Adicionar Clietnes</a>
	                        </li>
	                        <li>
	                            <a href="listar_clientes.php"><i class="fas fa-circle"></i> Listar Clientes</a>
	                        </li>
	                    </ul>
	                </li>
	                <li class="active">
	                    ...
	                    <ul class="collapse list-unstyled" id="homeS1ubmenu">
	                        <li>
	                            <a href="adicionar_planos.php"><i class="fas fa-circle"></i> Adicionar Planos</a>
	                        </li>
	                        <li>
	                            <a href="listar_planos.php"><i class="fas fa-circle"></i> Listar Planos</a>
	                        </li>
	                    </ul>
	                </li>
	                <li class="active">
	                    ...
	                    <ul class="collapse list-unstyled" id="newsletter">
	                        <li>
	                            <a href="listar_newsletter.php"><i class="fas fa-circle"></i> Listar Newsletter</a>
	                        </li>
	                    </ul>
	                </li>
	                <li class="active">
	                    ...
	                    <ul class="collapse list-unstyled" id="curriculos">
	                        <li>
	                            <a href="listar_curriculos.php"><i class="fas fa-circle"></i> Listar Curriculos</a>
	                        </li>
	                        <li>
	                        	<a href="curriculos_aceitos.php"><i class="fas fa-circle"></i> Curriculos Aceitos</a>
	                        </li>
	                        <li>
	                        	<a href="curriculos_rejeitados.php"><i class="fas fa-circle"></i> Curriculos Rejeitados</a>
	                        </li>
	                    </ul>
	                </li>
	                <li class="active">
	                    ...
	                    <ul class="collapse list-unstyled" id="config">
	                        <li>
	                            <a href="configs.php"><i class="fas fa-circle"></i> Informações do site</a>
	                        </li>
	                        <li>
	                        	<a href="template.php"><i class="fas fa-circle"></i> Template</a>
	                        </li>
	                    </ul>
	                </li>
